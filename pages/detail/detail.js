    ...
    wx.request({
      ...
      success: function(res){
        ...
        for (var i = 0; i < dataArray.length; i ++) {
          ...
          // 赋值
          // https://pic.ezparking.com.cn/rtpi-service/parking?key=P01890EQ52678RTX&type=photo&id=%@&file=%@
          var dic = dataArray[i];
          ...
          parkInfo.url = "https://pic.ezparking.com.cn/rtpi-service/parking?key=P01890EQ52678RTX&type=photo&id="+dic.id+"&file="+dic.photo;
          parkInfo.count = i;
          // 添加数组元素.
